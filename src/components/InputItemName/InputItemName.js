...
const InputItemName = () => {
	...
	const handleSubmit = (e) => {
		...
		itemList.find((item) => item.name === name) ? alert(`${name} is already on your list`) : dispatch(addItem(name));
	};
	...
	return (
		<form onSubmit={handleSubmit} id="item-form">
			<label id="label">
				Enter the item name:
				<input type="text" name="input-item" id="input-item" placeholder="Item name" onChange={handleChange} />
			</label>
